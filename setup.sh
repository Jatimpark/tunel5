...
echo "IP=$domain" > /var/lib/scrz-prem/
...
echo -e "└─────────────────────────────────────────┘"
sleep 1
wget -q https://raw.githubusercontent.com/Jatimpark/tunel5/main/tools/vnstat.sh && chmod +x vnstat.sh && ./vnstat.sh
echo -e "┌─────────────────────────────────────────┐"
echo -e " \E[42;1;37m          >>> Install SSH / WS <<<        \E[0m$NC"
echo -e "└─────────────────────────────────────────┘"
sleep 1
wget -q https://raw.githubusercontent.com/Jatimpark/tunel5/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
echo -e "┌─────────────────────────────────────────┐"
echo -e " \E[42;1;37m            >>> Install Xray <<<         \E[0m$NC"
echo -e "└─────────────────────────────────────────┘"
sleep 1
wget -q https://raw.githubusercontent.com/Jatimpark/tunel5/main/tools/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
echo -e "┌─────────────────────────────────────────┐"
echo -e " \E[42;1;37m           >>> Install Backup <<<           \E[0m$NC"
echo -e "└─────────────────────────────────────────┘"
sleep 1
wget -q https://raw.githubusercontent.com/Jatimpark/tunel5/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
sleep 2
...
wget -q -O /usr/bin/update "https://raw.githubusercontent.com/Jatimpark/tunel5/main/options/update.sh"
...
wget -q -O /usr/bin/cek-bw "https://raw.githubusercontent.com/Jatimpark/tunel5/main/options/cek-bw.sh"
wget -q -O /usr/bin/jam "https://raw.githubusercontent.com/Jatimpark/tunel5/main/tools/jam.sh"
wget -q -O /usr/bin/update-xray "https://raw.githubusercontent.com/Jatimpark/tunel5/main/tools/update-xray.sh"
...
echo  "   - SSH SSL Websocket       : 443, 8443, 2087, 2096" | tee -a log-install.txt
echo  "   - Stunnel5                : 445, 447, 777" | tee -a log-install.txt
echo  "   - Dropbear                : 109, 143" | tee -a log-install.txt
echo  "   - Badvpn                  : 7100-7300" | tee -a log-install.txt
echo  "   - Nginx                   : 81" | tee -a log-install.txt
echo  "   - XRAY  Vmess TLS         : 443, 8443, 2087, 2096" | tee -a log-install.txt
echo  "   - XRAY  Vmess None TLS    : 80, 8080, 8880, 2082" | tee -a log-install.txt
